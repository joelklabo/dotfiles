...
export PATH=/Users/joelklabo:$PATH
export PATH=/opt/local/bin:$PATH
export PATH=/opt/local/sbin:$PATH
export PATH=/sw2/bin:/sw2/sbin:/opt/local/bin:/opt/local/sbin:/users/joelklabo/depot_tools:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin:/Users/joelklabo/.rvm/bin:/usr/X11R6/bin:/opt/local/lib/postgresql90/bin:/usr/local/mysql/bin/:/users/joelklabo/development/flex_sdk4.1/bin/:/Users/joelklabo/development/selenium-remote-control-1.0.3/:/users/joelklab/development/pythonpath/:
...
PROMPT="${punctuation}${text_emph}%n${emph}:${final} "
